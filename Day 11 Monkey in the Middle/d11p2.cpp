...
int main()
{
    ...
    if (newfile.is_open())
    {
        ...
        vector<vector<unsigned long long int>> monkey;
        // stores the number of inspections for each monkey
        vector<int> inspect_count;
        vector<unsigned long long int> empty;
        ...
        for (int round = 1; round <= 10000; ++round)
        {
            for (int m = 0; m <= 7; ++m)
            {
                ...
                {
                    unsigned long long int worry = monkey[m][j];
        ...
        unsigned long long int first_active = 0;
        unsigned long long int second_active = 0;
